  ...
  try {
            ...
            if (ctx.message.text && ctx.message.text) {
              if (/\d/.test(ctx.message.text))
                ...
                await ctx.replyWithHTML(
                  // "Шаг 2: Назовите шоу\nВнимание❗️\nБронирование на шоу отчётный концерт СУББОТА 17.02 через чат бот остановлено❗️\nНаличие мест уточняйте по телефону +375291129579❗️❗️❗️\n<i>Можно указать несколько шоу\nнапример: Чего хотят женщины. Отчетный концерт пятница</i>\n\nПеред выбором шоу убедитесь, пожалуйста, в актуальности афиши в нашем Instagram📷 (расписание).\nhttps://www.instagram.com/\n\nОбращаем внимание❗️\nНа Открытый микрофон🎙️ бронировать места не нужно❗️"
                  "Шаг 2: Назовите шоу\nВнимание❗️\nПри бронировании мест на «Отчетный концерт» указывайте , пожалуйста, дату или день концерта❗️\n<i>Например: Отчетный концерт 17.02 или отчетный концерт пятница</i>\nМожно указать несколько шоу\n<i>например: Чего хотят женщины. Отчетный концерт пятница</i>\n\nПеред выбором шоу убедитесь, пожалуйста, в актуальности афиши в нашем Instagram📷 https://www.instagram.com/standupcomedyhall\n\nОбращаем внимание❗️\nНа Открытый микрофон🎙️ бронировать места не нужно❗️"
                );
    ...
    bot.start(async (ctx) => {
      try {
        ...
        console.log("conect");
        await ctx.reply(
          "Здравствуйте!\nЗдесь вы можете забронировать места или отменить бронирование на мероприятия в Stand Up Comedy Hall.\n\nПРИ БРОНИРОВАНИИ МЕСТ НА СОЛЬНЫЙ КОНЦЕРТ НИКИТЫ КУКАЛЕВА УКАЗЫВАЙТЕ, ПОЖАЛУЙСТА, ВРЕМЯ ШОУ 17:00 или 20:00 !!!\n\nДля этого ответьте, пожалуйста, на вопросы бота.\n\nВНИМАНИЕ! ВАЖНАЯ ИНФОРМАЦИЯ!\n❗️ Отчётные концерты (пятница, суббота) начинаются в 20:00 ❗️ Брони принимаются до 19.00 дня мероприятия.\n❗️❗️Оплата брони происходит на месте (картой или наличными) по факту прихода.\n❗️ Обращаем Ваше внимание, что Вы бронируете места за столиком либо за барной стойкой.\n❗️ Места за столиком рассчитаны на 4-х человек, поэтому просим Вас дружелюбно отнестись к возможной подсадке и гостям рядом с Вами. Надеемся на Ваше понимание и позитивное настроение.\n❗️ Для Вашего комфорта просим приходить МИНИМУМ за 30 минут до начала шоу (начало в 20:00) это позволит Вам комфортно расположиться, а также сделать заказ и пообщаться с нашими барменами🍹\n\nС мероприятиями клуба можно ознакомиться:\nhttps://www.instagram.com/standupcomedyhall/",
          Markup.keyboard([["Выбрать шоу", "Отменить бронирование", "Сброс"]])
            .oneTime()
            .resize()
        );
